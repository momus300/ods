 ...
 * EeDependencies
 *
 * @ORM\Table(name="ee_dependencies", indexes={@ORM\Index(name="fk_ee_dependencies_pas_datas_idx", columns={"pas_data_id"}), @ORM\Index(name="index3", columns={"code"})})
 * @ORM\Entity
 */
class EeDependencies
{
    /**
     * @var string
     *
